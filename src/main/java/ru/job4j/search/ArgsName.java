...
public class ArgsName {
        ...
        public static void main(String[] args) {
            ru.job4j.search.ArgsName jvm = ru.job4j.search.ArgsName.of(new String[]{"-Xmx=512", "-encoding=UTF-8"});
            System.out.println(jvm.get("Xmx"));

            ru.job4j.search.ArgsName zip = ru.job4j.search.ArgsName.of(new String[]{"-out=project.zip", "-encoding=UTF-8"});
