...
class SimpleCollectionTest {
    ...
    /*Этот метод показывает, как можно выбрать из коллекции группу элементов по некоторому условию/*
    ...
    /*_Библиотека AssertJ может работать с коллекциями, реализующими интерфейс java.util.Map*/
    @Test
    void assertMap() {
